...
ActiveRecord::Schema[7.0].define(version: 2022_12_07_101805) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.bigint "midwife_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["midwife_id"], name: "index_bookings_on_midwife_id"
  ...
  create_table "midwives", force: :cascade do |t|
    t.string "speciality"
    ...
    t.datetime "updated_at", null: false
    t.text "bio"
    t.index ["user_id"], name: "index_midwives_on_user_id"
  end
  ...
  create_table "notes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["mom_id"], name: "index_notes_on_mom_id"
  ...
  add_foreign_key "moms", "users"
  add_foreign_key "notes", "moms"
